...
(function () {
  ...
  add('ja', {
    ...
    'rua.setup.dmarcLabel': 'DMARC TXT の例',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': '外部宛て RUA の承認 TXT（参考：当社が自動発行）',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  const ruaEn = {
    ...
    'rua.setup.dmarcLabel': 'Example DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'External-destination authorization TXT (FYI: auto-issued by us)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('vi', {
    ...
    'rua.setup.dmarcLabel': 'Ví dụ DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'TXT ủy quyền RUA (tham khảo: hệ thống tự phát hành)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('th', {
    ...
    'rua.setup.dmarcLabel': 'ตัวอย่าง DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'TXT สำหรับอนุญาต RUA (อ้างอิง: ออกให้อัตโนมัติ)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('id', {
    ...
    'rua.setup.dmarcLabel': 'Contoh DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'TXT otorisasi RUA eksternal (FYI: diterbitkan otomatis)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('et', {
    ...
    'rua.setup.dmarcLabel': 'DMARC TXT näide',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'Välise RUA autoriseerimise TXT (info: automaatselt väljastatud)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('ko', {
    ...
    'rua.setup.dmarcLabel': 'DMARC TXT 예시',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': '외부 RUA 승인 TXT(참고: 당사 자동 발행)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('es', {
    ...
    'rua.setup.dmarcLabel': 'Ejemplo de DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'TXT de autorización RUA externa (FYI: emitido automáticamente)',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('de', {
    ...
    'rua.setup.dmarcLabel': 'Beispiel DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'Externer RUA-Autorisierungs-TXT',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('ru', {
    ...
    'rua.setup.dmarcLabel': 'Пример DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'TXT для авторизации внешнего RUA',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('zh', {
    ...
    'rua.setup.dmarcLabel': 'DMARC TXT 示例',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': '外部 RUA 授权 TXT',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('km', {
    ...
    'rua.setup.dmarcLabel': 'ឧទាហរណ៍ DMARC TXT',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'TXT សម្រាប់អនុញ្ញាត RUA ខាងក្រៅ',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
  ...
  add('my', {
    ...
    'rua.setup.dmarcLabel': 'DMARC TXT ဥပမာ',
    'rua.setup.dmarcExample': 'Host: _dmarc.example.com\nType: TXT\nValue: v=DMARC1; p=none; rua=mailto:{RUA_EMAIL}',
    ...
    'rua.setup.authLabel': 'ပြင်ပ RUA authorization TXT',
    'rua.setup.authExample': 'Host: example.com._report._dmarc.{RUA_AUTH_DOMAIN}\nType: TXT\nValue: v=DMARC1',
